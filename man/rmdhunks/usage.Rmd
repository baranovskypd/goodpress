...
This can be done by adding a [Pandoc raw attribute](https://pandoc.org/MANUAL.html#extension-raw_attribute) in your `index.Rmd` post file i.e. copy-paste the lines below where you want the More tag to appear:
