...
* Installed and activated the [Application Passwords plugin](https://wordpress.org/plugins/application-passwords/). _`Don't forget to keep your WordPress plugins up-to-date especially because of security updates.`_
* Created a new user with editor rights, not admin, and from the admin panel I created an application password for "rmarkdown" for that user. _`Doing this for an user with restricted access is safer.`_
