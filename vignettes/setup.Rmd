...
* In [`.Renviron`](https://rstats.wtf/r-startup.html#renviron), save username as `WP_USER` and password as `WP_PWD`. _Keep `.Renviron` safe, it contains secrets!_
...
Then refer to [the usage vignette](https://maelle.github.io/goodpress/docs/articles/goodpress.html#math-with-mathjax).
